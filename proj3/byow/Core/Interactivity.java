...
public class Interactivity {
        ...
        /** the avater to move */
        private TETile avater = Tileset.AVATAR;
        ...
        public static void main(String[] args) throws InterruptedException {
            ...
            byow.lab13.MemoryGame game = new byow.lab13.MemoryGame(40, 40, seed);

            game.startGame();
        }

        public Interactivity(int width, int height, long seed) {
